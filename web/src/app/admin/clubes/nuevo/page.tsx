...
import { createOrganizacion } from '@/lib/queries/adminQueries';
...
export default function NuevoClubPage() {
  ...
  // Genera el slug automáticamente a medida que escribe el nombre
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-black text-foreground tracking-tight flex items-center gap-2">
              <Building2 className="text-primary animate-bounce-subtle" size={28} /> Alta de Nuevo Club
            </h1>
            <p className="text-muted text-sm mt-1">Registra una nueva organización en la plataforma SaaS.</p>
          </div>
        </div>
        ...
        <div className="bg-surface-secondary/40 border border-border rounded-3xl p-6 md:p-8 shadow-md hover:shadow-lg transition-all duration-300 backdrop-blur-md animate-slide-up">
          {success ? (
            <div className="text-center py-12 animate-scale-in">
              ...
              <h2 className="text-2xl font-bold text-foreground mb-2">¡Club registrado exitosamente!</h2>
              <p className="text-muted mb-8">La organización ya está disponible para asignar profesores y organizadores.</p>
